...
require(['aceEle','zDialog','jqtips','jqueryForm','jqValidate','datepicker','tag','chosen','daterangepicker'],function() {
	...
	.next().on(ace.click_event, function(){
	 ...
	 $.post("/Photo/getAllPhotographer",function(data) {
		 if(data.status==0){
