...
require(['aceEle','zDialog','jqtips','jqueryForm','jqValidate','datepicker','tag','ueLang','chosen','ZeroClipboard'],function(aceEle,zDialog,jqtips,jqueryForm,jqValidate,datepicker,tag,ueLang,chosen,ZeroClipboard) {
	...
	var ueditor = UE.getEditor('contents',{
	      ...
	      serverUrl:baseUrl+"info/upload",//图片上传提交后台对应的地址
	});
